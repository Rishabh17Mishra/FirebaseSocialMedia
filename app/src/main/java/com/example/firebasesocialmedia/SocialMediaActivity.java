...
public class SocialMediaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void uploadImageToServer(){
        ...
        if (bitmap != null) {
            ...
            imageIdentifier = UUID.randomUUID() + ".png"; //Generates Unique Value for our image name here of PNG type
            ...
            uploadTask.addOnFailureListener( new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toasty.error( SocialMediaActivity.this, exception.toString(), Toasty.LENGTH_SHORT ).show();
                }
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    // ...
                    Toasty.success( SocialMediaActivity.this, "Upload Successful", Toasty.LENGTH_SHORT ).show();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        FirebaseDatabase.getInstance().getReference().child( "my_users" ).child( uids.get( position ) )
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toasty.success( SocialMediaActivity.this, "Image Sent", Toasty.LENGTH_SHORT ).show();
                }
            }
        } );
    }
